...
func (b *OldBot) GameScores(user Recipient, msg Editable) ([]GameHighScore, error) {
...
func (b *OldBot) SetGameScore(user Recipient, msg Editable, score GameHighScore) (*Message, error) {
	msgID, chatID := msg.MessageSig()
